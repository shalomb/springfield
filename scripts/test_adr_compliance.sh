#!/bin/bash
# test_adr_compliance.sh - Verify ADR-000 existence and sections

FILE="docs/adr/ADR-000-takeda-compliance.md"
...
grep -q "ADR-000: Takeda Compliance & Safety Standards" "$FILE" || { echo "FAIL: Missing Title"; exit 1; }
